...
class CSVLayout extends Layout {
  ...
  factory CSVLayout.parseLayout(String source, LogConfiguration configuration) {
    ...
    return CSVLayout(source: source, configuration: configuration, renderers: renderers, fixedText: fixed);
  }
