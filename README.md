...
* [$Amazon CloudWatch](https://github.com/NLog/NLog/wiki/Amazon CloudWatch-target)
* [$Amazon SNS](https://github.com/NLog/NLog/wiki/Amazon SNS-target)
* [$Amazon SQS](https://github.com/NLog/NLog/wiki/Amazon SQS-target)
...
* [$Google Logging](https://github.com/NLog/NLog/wiki/Google Logging-target)
...
* [$Microsoct Azure AppCenter](https://github.com/NLog/NLog/wiki/Microsoct Azure AppCenter-target)
* [$Microsoft Azure ApplicationInsights](https://github.com/NLog/NLog/wiki/Microsoft Azure ApplicationInsights-target)
* [$Microsoft Azure Blob Storage](https://github.com/NLog/NLog/wiki/Microsoft Azure Blob Storage-target)
* [$Microsoft Azure DataTables Storage](https://github.com/NLog/NLog/wiki/Microsoft Azure DataTables Storage-target)
* [$Microsoft Azure EventHubs](https://github.com/NLog/NLog/wiki/Microsoft Azure EventHubs-target)
* [$Microsoft Azure File System](https://github.com/NLog/NLog/wiki/Microsoft Azure File System-target)
* [$Microsoft Azure Queue Storage](https://github.com/NLog/NLog/wiki/Microsoft Azure Queue Storage-target)
* [$Microsoft Azure ServiceBus](https://github.com/NLog/NLog/wiki/Microsoft Azure ServiceBus-target)
* [$Microsoft Azure Table Storage](https://github.com/NLog/NLog/wiki/Microsoft Azure Table Storage-target)
* [$Pushover](https://github.com/NLog/NLog/wiki/Pushover-target)
* [$R7 InsightOps](https://github.com/NLog/NLog/wiki/R7 InsightOps-target)
...
* [$Sentry (Raven sdk)](https://github.com/NLog/NLog/wiki/Sentry (Raven sdk)-target)
* [$Sentry (Unified sdk)](https://github.com/NLog/NLog/wiki/Sentry (Unified sdk)-target)
